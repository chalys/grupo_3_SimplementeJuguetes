...
inputPhoneNumber.addEventListener("blur", function () {
  ...
  switch (true) {
    case !value.length:
      statusInvalid(errPhoneNumber, "El numero de teléfono es requerido", this);
      break;
    case isNaN(numberValue):
      statusInvalid(errPhoneNumber, "El numero de teléfono debe ser numérico", this);
      break;
    case numberValue <= 0 || !Number.isInteger(numberValue):
      statusInvalid(
        errPhoneNumber,
        "El numero de teléfono debe ser un número entero positivo",
        this
      );
      break;
    default:
